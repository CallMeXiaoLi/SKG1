		...
		success: function(str){
			...
			function getData1(){
				...
				for(var i = 0 ; i < str[0].goods.length; i++){
					html += '<dd><img src="../img1/' + str[0].goods[i].imgUrl + '" alt="" /><span class = "price">' + str[0].goods[i].price + '</span><a class = "title" href="detail.html">' + str[0].goods[i].title + '</a><p class = "country">' + str[0].goods[i].exportCountries + '<span></span><span></span></p><a class = "evaluate" href="#">' + str[0].goods[i].evaluate + '</a></dd>';
				}
